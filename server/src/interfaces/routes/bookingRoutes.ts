...
router.get("/slots/:hallid/:fordays", (req, res, next) =>
  bookingController.getAvailableSlots(req, res, next)
);
router.get("/slots/allslots/:hallid/:fordays", (req, res, next) =>
  bookingController.getAllSlotsOfHall(req, res, next)
);
router.put("/slots/update/:slotid", (req, res, next) =>
  bookingController.updateSlot(req, res, next)
);
