...
router.post(
  ...
  uploadImageArrayToCloudinary,
  (req, res, next) => hallController.createHall(req, res, next)
);
router.put("/update/:id", (req, res, next) =>
  hallController.updateHall(req, res, next)
);
router.delete("/delete/:id", (req, res, next) =>
  hallController.deleteHall(req, res, next)
);
router.get("/", (req, res, next) => hallController.getAllHalls(req, res, next));
router.get("/:id", (req, res, next) =>
  hallController.getHallById(req, res, next)
);
router.get("/available", (req, res, next) =>
  hallController.getAvailableHalls(req, res, next)
);
