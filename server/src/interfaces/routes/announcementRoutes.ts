...
router.get("/:id", (req, res, next) =>
  announcementController.getAnnouncementById(req, res, next)
);
router.put("/update/:id", adminMiddleware, (req, res, next) =>
  announcementController.updateAnnouncement(req, res, next)
);
router.delete("/delete/:id", adminMiddleware, (req, res, next) =>
  announcementController.deleteAnnouncement(req, res, next)
);
router.get("/", (req, res, next) =>
  announcementController.getAllAnnouncements(req, res, next)
);
