...
function sendMulticastNotification(tokens: string[], title: string, body: string): Promise<messaging.BatchResponse> {
  ...
  const obj=[`${'fPTa8Rsx5KRklb8hq-G8rz:APA91bHJWCU30Hay01_EC-rp4xL8KQcYDy00QbDuRX0TboHi0_4IhlH7MMQHkoJpaG7g9ZoZiFZRrkKECnLcJG6a7-qNwN8ZTBZQM5t6CYiitzoFJm9rWEc'}`]
